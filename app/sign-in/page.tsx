    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: '2rem', letterSpacing: '-0.02em', color: 'var(--brand)' }}>Selamat Datang</h1>
          <p style={{ color: 'var(--text-secondary)', marginTop: 8, fontSize: '0.95rem' }}>
            Masuk ke dashboard manajemen kos Anda
          </p>
        </div>
        ...
        <div className="card" style={{ padding: '36px 32px' }}>
          ...
          <div className="divider" style={{ marginBottom: 24 }}>atau</div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {error && (
              <div style={{ padding: '12px 16px', borderRadius: 'var(--radius)', background: 'var(--red-dim)', color: 'var(--red)', fontSize: '0.85rem' }}>
                {error}
              </div>
            )}
          ...
          <p style={{ textAlign: 'center', marginTop: 24, fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
            Belum punya akun?{' '}
            <Link href="/sign-up" style={{ color: 'var(--brand)', fontWeight: 700 }}>Daftar Gratis</Link>
          </p>
        </div>
      </div>
    </div>
